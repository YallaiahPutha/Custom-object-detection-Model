# python get_predictions.py --test_csv_path=/root/lab/object_detection/datasets/obj40/files/ground_truth.csv --cfg_path="/root/lab/object_detection/datasets/obj40/files/pipeline_mobilenet_v2_objn41_i0.config" --ckpt_path="/root/lab/object_detection/results/mobilenet_v2_objn41_i0/ckpt-250" --labels="/root/lab/object_detection/datasets/obj40/files/objn41.pbtxt" --out_dir=/root/lab/object_detection/datasets/obj40/results/mb1/ --conf_thr=0.1 
...
for img in img_annots:
    ...
    try:
        ...
        out_path = out_path
        cv2.imwrite(out_path,image_np_with_detections)
