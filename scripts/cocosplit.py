#python cocosplit.py "/root/lab/prime_team_projects/od_projects/project2/annotations/prop-250-modified-main.json" /root/lab/prime_team_projects/od_projects/project2/annotations/prop250/train250.json /root/lab/prime_team_projects/od_projects/project2/annotations/prop250/temp250.json -s 0.85
...
def main(args):
    with open(args.annotations, 'rt', encoding='UTF-8') as annotations:
        ...
        with open('split_status.txt', 'a') as f:
            f.write("Saved {} entries in {} and {} in {}".format(len(x), args.train, len(y), args.test))
            f.write("\n")
